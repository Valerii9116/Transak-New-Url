...
`;function I(t,e,n){return`
  ...
  `}function k(t){let{themeColor:e="1461db",widgetWidth:n="480px",widgetHeight:r="650px"}=t,o=document.createElement("style");return o.innerHTML=I(e,n,r),document.getElementsByTagName("head")[0]?.appendChild(o),o}function C(t,e){let n=k(t),r=document.createElement("div"),o=document.createElement("div"),a=c(d(t));return Object.assign(o,{id:"transakModal",innerHTML:T}),o.appendChild(a),Object.assign(r,{id:"transakRoot",onclick:()=>e()}),r.appendChild(o),document.getElementsByTagName("body")[0].appendChild(r),document.getElementById("transakCloseIcon")?.addEventListener("click",()=>e()),{styleElement:n,rootElement:r,iframeElement:a}}var m=new b.EventEmitter,p=class{#n;#r;#o;#e;#t=!1;static EVENTS=s;constructor(e){if(!e?.widgetUrl)throw new Error("[Transak SDK] => widgetUrl is required");this.#n=e}static on=(e,n)=>{s[e]&&m.on(e,n)};init=()=>{this.#t||(this.#s(),this.#t=!0)};cleanup=()=>{this.#r?.remove(),this.#i(),this.#e?.remove(),this.#t=!1};close=()=>{this.#r?.remove(),this.#o?.remove(),this.#i(),this.#e=void 0,this.#t=!1};#s=()=>{if(window.addEventListener("message",this.#a),this.#n.containerId){let{styleElement:e,iframeElement:n}=E(this.#n);this.#r=e,this.#e=n}else{let{styleElement:e,rootElement:n,iframeElement:r}=C(this.#n,this.#l);this.#r=e,this.#o=n,this.#e=r}};#l=()=>{this.#e?.contentWindow?.postMessage({event_id:"TRANSAK_WIDGET_CLOSE_REQUEST"},"*")};#i=()=>{m.removeAllListeners(),window.removeEventListener("message",this.#a)};#a=e=>{e?.data?.event_id&&this.#t&&m.emit(e.data.event_id,e.data.data)}};export{p as Transak};
